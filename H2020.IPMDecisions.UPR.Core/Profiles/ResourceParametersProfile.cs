...
namespace H2020.IPMDecisions.UPR.Core.Profiles
{
    public class ResourceParametersProfile : MainProfile
    {
        public ResourceParametersProfile()
        {
            ...
            CreateMap<FieldCropPestResourceParameter, FieldObservationResourceParameter>()
                .ForMember(dest => dest.Fields, opt => opt.Ignore())
                .ForMember(dest => dest.OrderBy, opt => opt.Ignore())
                .ForMember(dest => dest.SearchQuery, opt => opt.Ignore());

            CreateMap<FieldCropPestResourceParameter, FieldSprayResourceParameter>()
               .ForMember(dest => dest.Fields, opt => opt.Ignore())
               .ForMember(dest => dest.OrderBy, opt => opt.Ignore())
               .ForMember(dest => dest.SearchQuery, opt => opt.Ignore());

            CreateMap<FieldCropPestResourceParameter, FieldCropPestDssResourceParameter>()
                .ForMember(dest => dest.Fields, opt => opt.Ignore())
                .ForMember(dest => dest.OrderBy, opt => opt.Ignore())
                .ForMember(dest => dest.SearchQuery, opt => opt.Ignore());
        }
